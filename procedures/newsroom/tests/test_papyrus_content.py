...
class PapyrusContentTests(unittest.TestCase):
    ...
    def test_model_attachment_sha256_uses_full_digest(self) -> None:
        entry = build_text_model_payload_attachment(
            {
                "ownerKind": "reference",
                "ownerId": "reference-demo",
                "role": "metadata",
                "sortKey": "metadata",
        ...
        self.assertEqual(len(entry["attachment"]["sha256"]), 64)
