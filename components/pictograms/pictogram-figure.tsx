...
const REGISTRY: Record<ThreatIntelligencePictogramSlug, RegistryEntry> = {
  "the-balance-of-power-is-shifting": {
    aspectRatio: 1,
    render: BalanceShiftPictogram,
  },
  "how-our-newsroom-learns": {
    aspectRatio: 1,
    render: NewsroomFlowPictogram,
  },
  "audit-aws-exposure-before-attackers-do": {
    aspectRatio: 1,
    render: AwsDiscoveryPictogram,
  },
  "audit-azure-blast-radius-before-attackers-do": {
    aspectRatio: 1,
    render: AzureBlastRadiusPictogram,
  },
  "treat-openai-accounts-like-production-infrastructure": {
    aspectRatio: 1,
    render: OpenAIInfraPictogram,
  },
  "how-to-play-games-securely": {
    aspectRatio: 1,
    render: GamingIsolationPictogram,
  },
};
...
export function PictogramFigure({
  ...
  const entry = REGISTRY[registeredSlug];
