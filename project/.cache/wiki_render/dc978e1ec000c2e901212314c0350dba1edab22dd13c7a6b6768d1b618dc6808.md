...
## Retrieval improvements: hybrid search, entity graph, and ranking

`kanbus-17776450-72bc-4ffe-8f9d-4b976351a11d` · open · P1

Overall: 0 of 12 issues closed.

### Work items, by priority


- **P0** · Retrieval eval harness: golden queries + baseline — *open* · `kanbus-8e325221-e1e7-46cc-97ab-a30acd728db5`
- **P1** · Retire AI/ML-era passage scoring; extend for threat-intel report structure — *open* · `kanbus-5c7cde82-0e6d-4616-8e9c-7e69020e7a6c`
- **P1** · Hybrid lexical (BM25) retrieval with reciprocal rank fusion — *open* · `kanbus-a61c1227-e181-48fa-a38c-d379622950a7`
- **P2** · Named scope bundles for knowledge queries — *open* · `kanbus-31b5c612-7650-4e9f-9521-0f2bfc390294`
...
- **P3** · MCP server exposing LLM-free retrieval primitives — *open* · `kanbus-7311e1cf-789e-4dc1-9402-b301dd5d5b00`
...
These are recorded on the initiative and should not be relitigated without new
information:
