...
- **Lexical search** — BM25 over a gzipped inverted-index artifact in S3, built
  during vector sync and loaded stdlib-only in the Lambda. Its tokeniser keeps
  identifiers atomic: DOIs (slash intact), ISBNs, arXiv ids, PMIDs, CVEs,
  hashes, domains, IPs, ATT&CK technique ids, with defanged IOCs normalised.
...
Retrieval is now hybrid: a lexical arm and a vector arm, fused by reciprocal
rank fusion, with a golden-query harness to measure changes. Adding the lexical
arm took identifier queries from 0/5 to 5/5 and global Hit@5 from 76% to 96%,
with no other category disturbed — the first empirical confirmation on this
corpus that a single retriever is structurally blind to exact tokens. The current initiative addresses both, drawing on Cerebras's
...
## Knowledge base: make it safe to scale, and worth scaling

`kanbus-17776450-72bc-4ffe-8f9d-4b976351a11d` · in_progress · P1

Overall: 9 of 28 issues closed.

### Work items, by priority


- **P0** · Archive raw source bytes for all accepted references (link-rot insurance) — *closed* · `kanbus-88ab2a7c-7b95-4a80-bf4a-d57731b65243`
- **P0** · Retrieval eval harness: golden queries + baseline — *closed* · `kanbus-8e325221-e1e7-46cc-97ab-a30acd728db5`
- **P1** · End-to-end ingestion exercise: prove Phase 0/1 on fresh references — *open* · `TI-c46828bd-f792-452f-9c49-9f22d06ea730`
- **P1** · Assisted curation triage: automate around the decision, not the decision — *in_progress* · `kanbus-1f97c7b3-edfa-49e6-9b73-ca0c3fd9358d`
- **P1** · Retire AI/ML-era passage scoring; extend for threat-intel report structure — *closed* · `kanbus-5c7cde82-0e6d-4616-8e9c-7e69020e7a6c`
- **P1** · Hybrid lexical (BM25) retrieval with reciprocal rank fusion — *closed* · `kanbus-a61c1227-e181-48fa-a38c-d379622950a7`
- **P1** · Delete dead ranking config and unvalidated tuning knobs — *closed* · `kanbus-ca0de004-7432-4563-958d-ed111970d891`
- **P2** · Document and implement repeatable retrieval evaluation environments — *open* · `TI-5ed2f22c-35dc-4578-93a5-102008cd2c0e`
- **P2** · Reference entity extraction (distillation artifacts) — *open* · `kanbus-5cbc538f-bac6-49c3-b0a5-7be6ded1a77f`
- **P2** · Recency (age-decay) ranking signal — *open* · `kanbus-bb12d39b-89a3-4c76-ad1f-a39206627911`
- **P3** · Move passage heading weights out of engine code into per-corpus config — *open* · `TI-95ddf12f-ab9b-4857-a2dd-2ecdb5e6d8a6`
- **P3** · Entity resolution + graph promotion (curation-gated) — *open* · `kanbus-51975c24-841b-4456-bb70-5dfe2a960548`
- **P3** · Contextual chunk embeddings + low-signal gating; lift 8-chunk cap — *open* · `kanbus-7053038d-d569-4c20-9eb5-2ada186ae384`
- **P3** · Exploratory research budget: surface adjacent, unsteered territory — *open* · `kanbus-ef313421-ceec-4372-9855-5080dc15b733`
- **P4** · Named scope bundles for knowledge queries — *open* · `kanbus-31b5c612-7650-4e9f-9521-0f2bfc390294`
- **P4** · MCP server exposing LLM-free retrieval primitives — *open* · `kanbus-7311e1cf-789e-4dc1-9402-b301dd5d5b00`
- **P4** · Feature-flagged LLM rerank + context expansion (eval-gated) — *open* · `kanbus-ef3b35aa-00cc-4876-ac2c-df23816fadbe`

- **P2** · Coordinate vector index rebuilds — *open* · `kanbus-4b0aa611-6ded-4427-a9e1-1241f55613ac` *(operational)*
