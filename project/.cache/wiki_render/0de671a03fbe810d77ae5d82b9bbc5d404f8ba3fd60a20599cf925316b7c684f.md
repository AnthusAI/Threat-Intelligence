...
Overall: 0 of 15 issues closed.

### Work items, by priority


- **P0** · Archive raw source bytes for all accepted references (link-rot insurance) — *open* · `kanbus-88ab2a7c-7b95-4a80-bf4a-d57731b65243`
...
- **P1** · Delete dead ranking config and unvalidated tuning knobs — *open* · `kanbus-ca0de004-7432-4563-958d-ed111970d891`
...
Two epics are deferred at P4: named scope bundles (unnecessary at current corpus
size, and in tension with exploratory research) and MCP primitives (useful, not
load-bearing).
